    ...
    <div className="w-screen  h-screen sm:pb-60">
      ...
      <div className="max-w-[1240px] mx-auto text-white relative" >
        <div className="px-4 py-12">
          <h2 className=" md:text-3xl text-lg pt-8 text-slate-300 uppercase text-center" >Support</h2>
          <h3 className="md:text-5xl text-xl  font-bold py-6 text-center" >Finding the right crowd</h3>
        ...
        <div className="grid grid-cols-1 mx-2 md:grid-cols-2 relative gap-x-12 gap-y-24 sm:pt-20 text-black">
          <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <h3  className="font-bold md:text-2xl text-xl my-6">Get Involved</h3>
        ...
        <div className="bg-white rounded-xl shadow-2xl">
            <div className="p-8">
              ...
              <h3 className="font-bold md:text-2xl text-xl my-6">New Ideas</h3>
              <p className="text-gray-600 md:text-xl text-lg">
